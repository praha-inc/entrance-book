...
## 福利厚生の詳細
### 本購入補助
仕事に関連する書籍を60,000円/年まで購入できる制度です。

### 休暇
以下の休暇制度があります。

#### 有給休暇
入社半年経過で10日を付与し、以降は法定通り勤続年数に応じて増加します（6年半経過以降は20日）。
...
※葬儀などが海外で行われる場合、7日間を限度に日数を加算されます。
...
2026年現在、支給されるMacBook Proのスペックは以下の通りです。
...
※支給されるMacBook Proのスペックは、その時点で発売されている同等クラスの最新モデルとなります。（たとえばM6 Proが出たらM6 Proになります）
...
- 開催スパン: 6か月に1回
- 開催期間: 土日+金or月の2泊3日で行われることが多い（途中で帰宅しても良い）
